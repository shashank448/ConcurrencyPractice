...
public class Main {
    public static void main(String[] args) {
        ...
        Thread p3 = new Thread(new Philosopher(c3, c4, "Aurobindo"));
        Thread p4 = new Thread(new Philosopher(c4, c5, "Aristotle"));
        Thread p5 = new Thread(new Philosopher(c5, c1, "Pythagoras"));
        p1.start();
        p2.start();
        p3.start();
        p4.start();
